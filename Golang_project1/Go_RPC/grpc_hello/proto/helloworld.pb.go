...
type HelloRequest struct {
	...
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // 定义一个字段，类型为string，编号为1, 字段名称为name
...
type HelloReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Message       string                 `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` // 定义一个字段，类型为string，编号为1 , 字段名称为message
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
